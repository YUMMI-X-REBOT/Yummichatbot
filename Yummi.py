...
┏━━━━━━━━━━━━━━━━━┓
┣❥︎ [❄️︎𝐎𝐰𝐧𝐞𝐫❄️](https://t.me/{OWNER_USERNAME})
┣❥︎ [🍁𝐔𝐩𝐝𝐚𝐭𝐞𝐬🥀](https://t.me/{UPDATES_CHANNEL})
┣❥︎ [🍁𝐒𝐮𝐩𝐩𝐨𝐫𝐭🥀](https://t.me/{SUPPORT_GROUP})
┗━━━━━━━━━━━━━━━━━┛
...
@bot.on_message(filters.command(["/start", f"start@{BOT_USERNAME}", "/alive", ".alive", "#yummi", "#ritik"]) & filters.group & ~filters.edited)
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " 💥 𝐉𝐨𝐢𝐧 𝐎𝐮𝐫 𝐂𝐡𝐚𝐭 𝐆𝐫𝐨𝐮𝐩 💞", url=f"https://t.me/YummiSport")
                ]
            ]
        ),
    )
